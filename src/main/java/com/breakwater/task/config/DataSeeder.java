...
public class DataSeeder implements ApplicationRunner {
    ...
    public static final UUID JOHN_ID = UUID.fromString("b05beb44-b7f9-4ec8-ba41-5d0f5844a4ad");
    public static final UUID JOE_ID  = UUID.fromString("47c1a9b6-ea34-44f0-a157-411880c67003");

    public static final UUID COMPANY_ID             = UUID.fromString("5a0bbdbe-c872-4467-9070-b5284d7b658f");
    public static final UUID FINANCE_ID             = UUID.fromString("57633250-8e65-4b2a-b814-5838a1b8d3ff");
    public static final UUID ACCOUNTS_RECEIVABLE_ID = UUID.fromString("751edf8c-e1da-4d2a-9f1a-d1a5509ebdbb");
    public static final UUID ACCOUNTS_PAYABLE_ID    = UUID.fromString("816c100d-c4fa-49fd-ae79-c1faad385fad");
    public static final UUID HUMAN_RESOURCES_ID     = UUID.fromString("92ad705f-91ae-43ce-81ea-e5a1ca992a9e");
    public static final UUID EMPLOYEE_RELATIONS_ID  = UUID.fromString("f99c7a37-388b-4e63-a2b0-d898a2e345ea");
    public static final UUID RECRUITING_ID          = UUID.fromString("5439aee5-4f19-451c-865e-c9cc5e588751");
